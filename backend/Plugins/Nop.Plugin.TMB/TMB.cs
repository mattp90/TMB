...
{
    public class TMB : Nopalm.Nopalm
    {
        IPermissionService _permissionService;
        ILocalizationService _localizationService;
        IWorkContext _workContext;

        public TMB(ISettingService settingService, IPermissionService permissionService, IWorkContext workContext,
        ...
        public const string PLUGIN_NAME_SPACE = "Nop.Plugin.TMB";
    ...
    public class TMBStartup : INopStartup
    {
            ...
            services
                ...
                .AddRazorRuntimeCompilation(options =>
                {
                    options.FileProviders.Add(new EmbeddedFileProvider(
                        typeof(TMB).GetTypeInfo().Assembly,
                        TMB.PLUGIN_NAME_SPACE
                    ));
                });
        }
